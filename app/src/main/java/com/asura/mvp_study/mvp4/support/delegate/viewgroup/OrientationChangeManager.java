 ...
 * @param <P>
 */
public class OrientationChangeManager<V extends IMvpView, P extends IMvpPresenter<V>> {
	 ...
	 */
	static final class CacheEntry<V extends IMvpView, P extends IMvpPresenter<V>> {
		P presenter;
