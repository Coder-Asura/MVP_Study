 ...
 *
 */
public abstract class MvpRelativeLayout<V extends IMvpView, P extends IMvpPresenter<V>>
		extends RelativeLayout implements IMvpViewGroupDelegateCallback<V, P>,
		IMvpView {
