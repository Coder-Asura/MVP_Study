 ...
 * @param <P>
 */
public class MvpViewDelegateImpl<V extends IMvpView, P extends IMvpPresenter<V>>
		implements IMvpViewDelegate<V, P> {

	private IMvpViewDelegateCallback<V, P> delegateCallback;
	private OrientationChangeManager<V, P> orientationChangeManager;
	
	// 当前布局对应的id
	private int viewId;

	public MvpViewDelegateImpl(
			IMvpViewDelegateCallback<V, P> delegateCallback) {
