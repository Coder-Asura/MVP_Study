...
import com.asura.mvp_study.mvp4.support.delegate.activity.IMvpActivityDelegate;
import com.asura.mvp_study.mvp4.support.delegate.activity.IMvpActivityDelegateCallback;
import com.asura.mvp_study.mvp4.support.delegate.activity.MvpActivityDelegateImpl;
...
public abstract class MvpActivity<V extends IMvpView, P extends IMvpPresenter<V>>
		extends FragmentActivity implements IMvpActivityDelegateCallback<V, P>, IMvpView {

	private P presenter;

	private IMvpActivityDelegate<V, P> activityMvpDelegate;
	
	//是否保存数据
	private boolean retainInstance;

	protected IMvpActivityDelegate<V, P> getActivityMvpDelegate() {
		if (this.activityMvpDelegate == null) {
			this.activityMvpDelegate = new MvpActivityDelegateImpl<V, P>(this);
		}
