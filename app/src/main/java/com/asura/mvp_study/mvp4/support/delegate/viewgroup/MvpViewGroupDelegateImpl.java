package com.asura.mvp_study.mvp4.support.delegate.viewgroup;
...
/**
 * 以下代理是针对布局的代理 目标对象：MvpViewGroupDelegateImpl
 * 
 * @author Dream
 *
 * @param <V>
 * @param <P>
 */
public class MvpViewGroupDelegateImpl<V extends IMvpView, P extends IMvpPresenter<V>>
		implements IMvpViewGroupDelegate<V, P> {

	private IMvpViewGroupDelegateCallback<V, P> delegateCallback;
	private OrientationChangeManager<V, P> orientationChangeManager;
	
	// 当前布局对应的id
	private int viewId;

	public MvpViewGroupDelegateImpl(
			IMvpViewGroupDelegateCallback<V, P> delegateCallback) {
