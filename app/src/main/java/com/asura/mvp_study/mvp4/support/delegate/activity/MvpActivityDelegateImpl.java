...
public class MvpActivityDelegateImpl<V extends IMvpView, P extends IMvpPresenter<V>>
		implements IMvpActivityDelegate<V, P> {

	private MvpDelegateCallbackProxy<V, P> proxy;
	// 具体的目标接口实现类，需要持有创建Mvp实例
	private IMvpActivityDelegateCallback<V, P> delegateCallback;

	public MvpActivityDelegateImpl(
			IMvpActivityDelegateCallback<V, P> delegateCallback) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//以下是处理保存状态逻辑
		if(instance != null && instance instanceof MvpActivityConfigurationInstance){
			MvpActivityConfigurationInstance<V,P> configurationInstance = (MvpActivityConfigurationInstance<V,P>) instance;
	...
	public Object onRetainCustomNonConfigurationInstance() {
		...
		// 需要缓存
		return new MvpActivityConfigurationInstance<V, P>(presenter, instence);
	}
